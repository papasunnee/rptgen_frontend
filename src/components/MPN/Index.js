            ...
            >
              <div className={`${descriptionStyles.Inputlist}`}>
                ...
                <div className={`${descriptionStyles.Inputlist_con}`}>
                  ...
                  <input type="date" name="dominant_hand" />
                </div>
                ...
                <div className={`${descriptionStyles.Inputlist_con}`}>
                  ...
                  <input type="text" placeholder="19" name="dominant_hand" />
                ...
                <div className={`${descriptionStyles.Inputlist_con}`}>
                  ...
                  >
                    <label>
                      Did the insurance company or your emploer provide a doctor
                      whose office is 30 minutes or 15 miles from your home or
                      work place?{" "}
                    </label>
                    <Switch
                      uncheckedIcon={false}
