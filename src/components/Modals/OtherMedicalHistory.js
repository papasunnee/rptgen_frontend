                            ...
                            <div className={`${descriptionStyles.Inputlist}`}>
                                <div className={`${descriptionStyles.Inputlist_con}`}>
                                    <div className={`${descriptionStyles.Label_checkbox_con}`} style={{ justifyContent: "space-between" }}>
                                        ...
                                        <label style={{ fontSize: "15px", marginRight: "21px" }}>Marital Status:</label>
                                ...
                                <div className={`${descriptionStyles.Inputlist_con}`}>
                                    <div className={`${descriptionStyles.Label_checkbox_con}`} style={{ justifyContent: "space-between" }}>
                                        ...
                                        <label style={{ fontSize: "15px", marginRight: "23px" }}>Living:</label>
                                        <LivingstatusTrigger />
                                    </div>
                                </div>
                                ...
                                <div className={`${descriptionStyles.Inputlist_con}`}>
                                    <div className={`${descriptionStyles.Label_checkbox_con}`} style={{ justifyContent: "space-between" }}>
                                        ...
                                        <label style={{ fontSize: "15px", marginRight: "21px" }}>Smoking:</label>
                                ...
                                <div className={`${descriptionStyles.Inputlist_con}`}>
                                    <div className={`${descriptionStyles.Label_checkbox_con}`} style={{ justifyContent: "space-between" }}>
                                        ...
                                        <label style={{ fontSize: "15px" }}>No. of cigarettes a day:</label>
                                        <input
                                            type="text"
                                            name="dominant_hand"
                                            value={form.dominant_hand}
                                ...
                                <div className={`${descriptionStyles.Inputlist_con}`}>
                                    <div className={`${descriptionStyles.Label_checkbox_con}`} style={{ justifyContent: "space-between" }}>
                                        ...
                                        <label style={{ fontSize: "15px", marginRight: "21px" }}>Alcohol:</label>
                                        <AlcoholstatusTrigger />
                                    </div>
                                </div>

                                <div className={`${descriptionStyles.Inputlist_con}`}>
                                    <div className={`${descriptionStyles.Label_checkbox_con}`} style={{ display: "block" }}>
