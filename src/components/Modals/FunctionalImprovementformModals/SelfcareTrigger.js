...
function SelfcareTrigger({ form, setForm }) {
  ...
  return (
    <>
      <div className={`${frame44Styles.Selectinput} col-md-3`}>
        <input
          type="text"
          placeholder="Click and select self care and personal hygiene"
          name="self_care"
...
const OptionsList = [
  { id: 0, name: "Bathing", isActive: false },
  { id: 1, name: "Brushing Teeth", isActive: false },
  { id: 2, name: "Combing Hair", isActive: false },
  { id: 3, name: "Defacating", isActive: false },
  { id: 4, name: "Dressing oneself", isActive: false },
  { id: 5, name: "Eating", isActive: false },
  { id: 6, name: "Urinating", isActive: false },
